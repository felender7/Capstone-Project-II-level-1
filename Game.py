...
pygame.display.set_caption('Space Monster')
...
enemy1 = pygame.image.load("monsterBlue.png")
enemy2 = pygame.image.load("monsterRed.png")
enemy3 = pygame.image.load("monsterYellow.png")
...
while 1:
    ...
    for count in range (0,distance):
        ...
        # Set the screen to white background  and moves the image to the new X and Y positions (The loop running through the changing positions is what makes the image appear to move)
